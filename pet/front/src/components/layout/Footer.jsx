      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            <h3 className="text-white text-xl font-bold mb-4">🐾 PawFinds</h3>
            <p className="text-sm max-w-md leading-relaxed text-white/30">
              Finding loving homes for pets since 2024. We connect shelters with adopters to make every pet's dream of a family come true.
            </p>
          </div>
          <div>
