  ...
  theme: {
    extend: {
      colors: {
        ...
        warm: { DEFAULT: '#FAEEDA', alt: '#f5ede4', dark: '#E8DDD0' },
        urgent: { DEFAULT: '#e53e3e', light: '#fee2e2' },
        nouveau: { DEFAULT: '#f59e0b', light: '#fef3c7' },
        sos: { DEFAULT: '#D85A30', light: '#fef2ef' },
      ...
      animation: {
        ...
        'pulse-urgent': 'pulse 1.5s ease-in-out infinite',
