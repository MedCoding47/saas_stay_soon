...
{
    /// <inheritdoc />
    public partial class AddSaaSUserRoles : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PetName = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdoptRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdoptRequests_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AdoptRequests_Users_RespondedById",
                        column: x => x.RespondedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_AdoptRequests_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyProfiles_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VeterinaireProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VeterinaireProfiles_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VeterinaireProfiles_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Advice_VeterinaireProfiles_VeterinaireProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bookings_VeterinaireProfiles_VeterinaireProfileId",
                        column: x => x.VeterinaireProfileId,
                        principalTable: "VeterinaireProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdoptRequests_OrganizationId",
                table: "AdoptRequests",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_AdoptRequests_RespondedById",
                table: "AdoptRequests",
                column: "RespondedById");

            migrationBuilder.CreateIndex(
                name: "IX_AdoptRequests_Status",
                table: "AdoptRequests",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_AdoptRequests_UserId",
                table: "AdoptRequests",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Advice_VeterinaireProfileId",
                table: "Advice",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_VeterinaireProfileId",
                table: "Bookings",
                column: "VeterinaireProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyProfiles_OrganizationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_UserId_PetId",
                table: "Favorites",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VeterinaireProfiles_OrganizationId",
                table: "VeterinaireProfiles",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_VeterinaireProfiles_UserId",
                table: "VeterinaireProfiles",
                column: "UserId",
                unique: true);
