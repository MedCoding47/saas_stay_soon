...
namespace PawFinds.Infrastructure.Migrations
{
    ...
    [Migration("20260530202718_AddReviews")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PawFinds.Domain.Entities.NewsletterSubscriber", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PawFinds.Domain.Entities.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PawFinds.Domain.Entities.PetCareRecommendation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PetCareRecommendations", (string)null);
                });
            ...
            modelBuilder.Entity("PawFinds.Domain.Entities.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PawFinds.Domain.Entities.Payment", b =>
                {
                    b.HasOne("PawFinds.Domain.Entities.Booking", "Booking")
                        .WithMany()
            ...
            modelBuilder.Entity("PawFinds.Domain.Entities.Review", b =>
                {
                    b.HasOne("PawFinds.Domain.Entities.User", "Author")
                        .WithMany()
